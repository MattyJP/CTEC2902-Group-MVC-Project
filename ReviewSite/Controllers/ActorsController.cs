...
namespace ReviewSite.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ActorId,Name,DateOfBirth,ActorSummary")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ActorId,Name,DateOfBirth,ActorSummary")] Actor actor)
        {
            if (ModelState.IsValid)
            {
